        ...
        {filtered.length === 0 ? (
          ...
          <div className="space-y-3">
            {filtered.map((task) => (
              <div
                key={task.id}
                className={`flex items-center gap-4 p-4 rounded-lg border border-border/50 transition-all hover:border-border ${
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`font-medium truncate ${task.status === "done" ? "line-through" : ""}`}>
                    {task.title}
                  </p>
                  {task.description && (
